...
REGEL_CHANNEL_ID = 1534624451662970920  # Passe hier deine Kanal-ID an
...
async def setup(bot):
    ...
    if regeln_channel:
        ...
        if not exists:
            ...
            # Paragraphen aufteilen, damit es übersichtlich in Embed-Felder passt
            embed.add_field(
            ...
            embed.add_field(
                ...
                value="• **Rettungsdienst & Feuerwehr:** Realistisches RP, faire Behandlung, zuständig für Brände, Unfälle und Notrufe.\n• **Funk:** Keine Beleidigungen/Spam, hohe Funkdisziplin.\n• **Fahrzeuge:** Keine absichtlichen Rammaktionen oder mutwillige Zerstörung.",
                inline=False
            )

            embed.add_field(
                name="§17 - §20 Trolling, Werbung, Team & Strafen",
                value="• **Trolling & Werbung:** Abschiedliches Stören, Soundboards und Fremdwerbung (Discord/Roblox/Social Media) verboten.\n• **Team:** Anweisungen des Teams sind folge zu leisten.\n• **Strafen:** Verwarnung, Kick, Temp-Bann oder Permanenter Bann je nach Härte.\n\n*Realistisches und faires Roleplay sorgt für mehr Spielspaß für alle!*",
                inline=False
            )
