...
# --- EINSTELLUNGEN FÜR ROLLEN-ZUGRIFF ---
# Trage hier die Rollen-IDs ein, die Zugriff auf ALLE Tickets haben dürfen
TEAM_ROLE_IDS = [
    # 123456789012345678,  # <-- Hier Team-Rollen-ID eintragen (optional)
]
